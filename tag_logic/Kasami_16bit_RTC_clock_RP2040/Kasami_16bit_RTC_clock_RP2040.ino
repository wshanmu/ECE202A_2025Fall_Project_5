/*
 * PN Code Generator based on external RTC clock - RP2040 VERSION
 *
 ...
 *
 * OPTIMIZATIONS:
 * - Uses direct GPIO register access for fast pin updates
...
void setup() {
  ...
  Serial.println("I2C pins disabled (set to INPUT mode)");
